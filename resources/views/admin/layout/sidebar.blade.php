<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            {{--<li class="header"></li>--}}
            <li class="<?php  if(in_array(request()->route()->uri(),['admin/permissions','admin/users', 'admin/roles'])){echo 'active';} ?> treeview">
                <a href="#">
            ...
            <li class="<?php  if(mb_substr(request()->route()->uri(), 0, 11) == 'admin/posts'){echo 'active';} ?> treeview">
                <a href="/admin/posts">
